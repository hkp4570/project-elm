      ...
      <transition name="router-fade">
        <section v-if="categoryType===1">
          <section class="hongbao_container">
            <header class="hongbao_title">
              ...
              <section class="hongbao_description">
                ...
                <router-link to="/discount/hbDescription" class="hongbao_detail">红包说明</router-link>
              </section>
            </header>
          ...
          <footer class="hongbao_footer">
            <router-link to="/discount/exchange" class="hongbao_style" style="border-right: 1px solid #f5f5f5">
              兑换红包
            </router-link>
