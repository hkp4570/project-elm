...
export default {
  data() {
    return {
      ...
      changeShowType: 'food', // 显示食品列表还是评价列表
      menuList: [],
  ...
  <div>
    <section v-if="!showLoading" class="shop_container">
        ...
        <section class="description_header">
          <router-link to="/shop/shopDetail" class="description_top">
            ...
            <section class="description_right">
              ...
              <p class="description_text">商家配送/{{
                  shopDetailData.order_lead_time
                }}分钟送达/配送费¥{{ shopDetailData.float_delivery_fee }}</p>
      ...
      <section class="change_show_type" ref="chooseType">
        <div>
          <span :class="{activity_show: changeShowType === 'food'}" @click.stop="changeShowType = 'food'">商品</span>
        </div>
        <div>
          <span :class="{activity_show: changeShowType === 'rating'}"
                @click.stop="changeShowType = 'rating'">评价</span>
